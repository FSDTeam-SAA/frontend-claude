        ...
        <div className="bg-[#CDFFCD] py-10 md:py-16 lg:py-20">
            <div className="container grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="md:col-span-1 h-full flex flex-col justify-center">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-black leading-[150%] pb-2 md:pb-5 lg:pb-6">Data</h3>
                ...
                <div className="md:col-span-1">
                    <Image src="/assets/images/data.jpg" alt="data" width={500} height={500} className='w-full h-[400px] md:h-[550px] lg:h-[778px] object-contain !rounded-[16px]  ' />
                </div>
            </div>
        </div>
    )
