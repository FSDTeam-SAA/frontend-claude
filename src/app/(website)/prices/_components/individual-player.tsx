    ...
    return (
        <div className="bg-[#EBEBEB] py-10 md:py-16 lg:py-24">
            <div className="container ">
                <h3 className='text-2xl md:text-3xl lg:text-[40px] text-[#131313] h_underline leading-[120%] font-normal text-center'>Pricing For Individual Player</h3>
                ...
                <div className='w-full flex items-center justify-center gap-6 pt-7 md:pt-9 lg:pt-12'>
                    {
                        subscriptionData?.map((item) => {
                            return <div key={item?._id} className="w-full md:w-1/3 border-[1.5px] border-[#1E3A8A] rounded-[16px]">
                                <h4 className='bg-[#006600] rounded-t-[14px] text-lg md:text-xl lg:text-[22px] font-normal text-white leading-[120%] text-center py-6 md:py-8 lg:py-10'>{item?.description}</h4>
